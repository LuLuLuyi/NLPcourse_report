...
class TextLSTM(nn.Module):
    def __init__(self):
        ...
        self.LSTM_1 = nn.LSTM(input_size=emb_size, hidden_size=n_hidden)
        self.LSTM_2 = nn.LSTM(input_size=n_hidden, hidden_size=n_hidden)
    ...
    def forward(self, X):
        ...
        outputs_2 = outputs_2[-1] # [batch_size, num_directions(=1) * n_hidden]
        model = self.W(outputs_2) + self.b # model : [batch_size, n_class]
        return model
...
if __name__ == '__main__':
    ...
    learn_rate = 0.0005
    all_epoch = 10 #the all epoch for training
